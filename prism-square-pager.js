...
/**
 * `<prism-square-pager>` is a [Polymer 3](http://polymer-project.org/) element provides pagination designed by material design via `<prism-pagination>`.
 *
 * # Usage
 *
 * ```
 ...
 * ## Styling
 *
 * `<prism-square-pager>` provides the following custom properties and mixins for styling:
 *
 ...
 *
 * @memberof Prhythm
 * @element prism-square-pager
 * @customElement
 * @polymer
 */
class PrismSquarePager extends PolymerElement {

  static get is() { return 'prism-square-pager'; }
...
customElements.define(PrismSquarePager.is, PrismSquarePager);
